Progettare un interface di nome Smartphone, per rappresentare un telefono cellulare
...
il cellulare.La classi FirstUser-SecondUser-ThirdUser deve dichiarare nell'interfaccia 
e implementare nelle classi i seguenti metodi: un
metodo definito come public ricarica(double unaRicarica), che ricarica il
